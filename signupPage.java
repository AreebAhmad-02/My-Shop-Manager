...
public class signupPage extends JFrame implements ActionListener {
    ...
    JLabel namelbl, title, ContactNumberlbl, CNIClbl, addresslbl, DOBlbl, usernamelbl, passwordlbl, confirmpasswordlbl,
            picture;
    ...
    public void filehandled() {
        ...
        File usersignupsetails = new File("src\\SignupDetails.txt");
        ...
        try {
            FileWriter fileWriter = new FileWriter("src//SignupDetails.txt", true);
